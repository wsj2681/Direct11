...
Mesh::Mesh(ComPtr<ID3D11Device>& device, const vector<ColorVertex>& vertices, const vector<UINT>& indices)
{
...
void Mesh::CreateVertexBuffer(ComPtr<ID3D11Device>& device, const vector<ColorVertex>& vertices)
{
